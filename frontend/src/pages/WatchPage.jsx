...
const AdsIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="server-ads-icon" aria-label="Contains ads">
        <title>contain-ads</title>
        <path fillRule="evenodd" clipRule="evenodd" d="M12 2L1 21h22L12 2zm-1 7h2v5h-2V9zm2 8h-2v-2h2v2z" />
    </svg>
);
